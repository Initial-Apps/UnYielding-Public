...
export interface IUnyieldingTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IUnyieldingTabRemoveProps {

}

/**
 * Implementation of unyielding Tab remove page
 */
export class UnyieldingTabRemove  extends TeamsBaseComponent<IUnyieldingTabRemoveProps, IUnyieldingTabRemoveState> {
